...
async function checkNumberOfTodosInLocalStorage(page, expected) {
  ...
  return await page.waitForFunction((e) => JSON.parse(localStorage['react-todos']).length === e, expected);
}
...
async function checkNumberOfCompletedTodosInLocalStorage(page, expected) {
  // eslint-disable-next-line no-return-await
  return await page.waitForFunction((e) => JSON.parse(localStorage['react-todos']).filter((/** @type {{ completed: any; }} */ i) => i.completed).length === e, expected);
}
...
async function checkTodosInLocalStorage(page, title) {
  // eslint-disable-next-line no-return-await
  return await page.waitForFunction((t) => JSON.parse(localStorage['react-todos']).map((/** @type {{ title: any; }} */ i) => i.title).includes(t), title);
}
